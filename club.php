...
section.home-section-1 {
  ...
  background: url(http://cuckoosnest.afamilyfriendgroup.org/wp-content/uploads/2016/10/Slide_ImageHero.png) no-repeat bottom center fixed;
	...
	<section id="benefits" class="club-section club-section-6 club-section-padding text-center">
		<div class="container">
			...
			<div class="row" style="width: 50%; margin-left: auto; margin-right: auto;text-align: center;">
				<div class="col-md-12">
					<p style="color: white; font-size: 17px;">Online access to member directory and event calendar</p>
					<p style="color: white; font-size: 17px;">Regular member newsletter</p>
					<p style="color: white; font-size: 17px;">Invitations to guest speakers visiting BootUP</p>
					<p style="color: white; font-size: 17px;">Access to monthly startup pitch events</p>
					<p style="color: white; font-size: 17px;">Behind the scenes visits to Bay Area companies</p>
					<p style="color: white; font-size: 17px;">Participate in a variety of social and cultural events</p>
					<p style="color: white; font-size: 17px;">Hot desking at BootUP in Menlo Park</p>
