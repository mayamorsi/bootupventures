...
.club-section-2, .club-section-4, .club-section-6 {
	color: #fff;
}
.club-section-1 h2 {
	color: #bc7642;
 ...
 <section id="benefits" class="club-section club-section-6 club-section-padding text-center">
  <div class="container">
   ...
   <div class="row" style="width: 50%; margin-left: auto; margin-right: auto;text-align: center;">
    <div class="col-md-12">
     <p>Online access to member directory and event calendar</p>
     <p>Regular member newsletter</p>
     <p>Invitations to guest speakers visiting BootUP</p>
     <p>Access to monthly startup pitch events</p>
     <p>Behind the scenes visits to Bay Area companies</p>
     <p>Participate in a variety of social and cultural events</p>
     <p>Hot desking at BootUP in Menlo Park</p>
     <p>Host business meetings in a relaxed garden setting</p>
    </div>
   </div>
   <br/>
