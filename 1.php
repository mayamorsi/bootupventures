...
<div class="container-fluid" style="margin:0;padding:0">
    <div class="content-section-events"></div>
    <div class="row" style="margin:0; background: transparent">
        <div class="col-md-6 events-panel">
            <h1 style="font-size: 60px;">EVENTS</h1>
            <p>BootUP offers an attractive venue for high-quality events at the heart of Silicon Valley. Since 2013, we have hosted over 500 events bringing together more than 10,000 participants at our Menlo Park location. BootUP has a fully equipped event studio and a serene outdoor courtyard with a large lawn, tables, sofas and armchairs around gas powered fire pits. Unlike your typical tech meetup, BootUP gives you the feeling of an upscale private club. It is at BootUP that you meet high-power serial entrepreneurs, senior corporate executives and leading investors. There is no better place in the Valley to connect the dots.</p>
        </div>
...
<div style="margin-right:30px;">
    <div class="col-md-12" style="border-bottom: 1px solid;padding: 20px 0;">
        <div class="col-md-4" style="padding-left: 0;padding-right: 0;">
            <img style="width:100%;height:120px;" src="' . $result['1']['logo']['original']['url'] . '">
        </div>
...
';
    ...
    <div class="col-md-12" style="border-bottom: 1px solid;padding: 20px 0;">
        <div class="col-md-4" style="padding-left: 0;padding-right: 0;">
            <img style="width:100%;height:120px;" src="' . $result['2']['logo']['original']['url'] . '">
        </div>
        <div class="col-md-8" style=padding-top:30px;>
            <div class="">' . $date2 . '</div>
...
<div class="container">
    <br>
    <center><h2 style="color: #818181;">Our event spaces in the heart of Silicon Valley</h2></center><br><br>
    <div class="row">
        <div class="col-md-4" style="text-align: -webkit-right;text-align: -moz-right;">
            ...
            <p class="eventp">The Cuckoo's Nest is a great venue for private events and parties with up to 130 people.</p>
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="http://cuckoosnestclub.com/" target="_blank"><button class="visitbtn pull-right btn11">VISIT</button></a>
                </div>
            </div>
            <br><br>
        </div>
        <div class="col-md-4" style="text-align: -webkit-right;text-align: -moz-right;">
            ...
            <p class="eventp">This event space is great for conferences, workshops, panel discussions and professional presentations.</p>
            <ul class="a">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="contacts.php"><button class="cntcbtn pull-right">CONTACT US</button></a>
                </div>
            </div>
            <br><br>
        </div>
        <div class="col-md-4" style="text-align: -webkit-right;text-align: -moz-right;">
            ...
            <ul class="a">
                ...
                <a href="https://suitabletech.com/beampro/" target="_blank"><li style="color: #818181;">Beam Access</li></a>
                <li>Projector</li>
                <li>Whiteboards</li>
                <li>WiFi access</li>
                <li>Microphones</li>
