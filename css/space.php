...
<body data-spy="scroll" data-target=".navbar-fixed-top" id="page-top">
    ...
    <div class="not-show-mobile">
        ...
        <div class="container" style="text-align:center;">
            <br>
            <h2 style="color:orange;">Companies</h2>
            <br><br>
            <div class="row">
                <div class="col-md-3 vcenter"><img alt="mentorcloud_logo" class="spaceicon1" src=
                "img/mentorcloud_logo@2x.png"></div>
                <br class="visible-xs"><br class="visible-xs">
                <div class="col-md-3 vcenter"><img alt="hellobaby_logo" class="spaceicon2" src=
                "img/hellobaby_logo@2x.png"></div>
                <br class="visible-xs"><br class="visible-xs">
                <div class="col-md-3 vcenter"><img alt="swiftmile_logo" class="spaceicon3" src=
                "img/swiftmile_logo@2x.png"></div>
                <br class="visible-xs"><br class="visible-xs">
                <div class="col-md-3 vcenter"><img alt="mokloud_logo" class="spaceicon4" src=
                "img/mokloud_logo@2x.png"></div>
                <br class="visible-xs"><br class="visible-xs">
            </div>
            <div class="row" style="margin-top: 3em;">
                <div class="col-md-3 vcenter"><img alt="magisto_logo" class="spaceicon5" src=
                "img/magisto_logo@2x.png"></div>
                <br class="visible-xs"><br class="visible-xs">
                <div class="col-md-3 vcenter"><img alt="piedparker" class="spaceicon6" src=
                "img/iedparker_logo@2x.png"></div>
                <br class="visible-xs"><br class="visible-xs">
                <div class="col-md-3 vcenter"><img alt="unravel_logo" class="spaceicon7" src=
                "img/unravel_logo@2x.png"></div>
                <br class="visible-xs"><br class="visible-xs">
                <div class="col-md-3 vcenter"><img alt="cocooncam_logo" class="spaceicon8" src=
                "img/cocooncam_logo@2x.png"></div>
            </div>
            <div id="contact-corporate-portfolio">
            <fieldset>
                <a href="portfolio.php"><button name="submit" type="submit" style="color: rgb(203,141,84); border-color: rgb(203,141,84);cursor: pointer; padding: 10px; background: #FFF; margin: 3em auto; display: table; font-size: 14px; border: 1px solid;}">FULL PORTFOLIO</button></a>
            </fieldset>
        </div>
        </div><br>
        <br>
